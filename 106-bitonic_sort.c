 ...
 * subarray
 * @ascending: if true, sort in ascending order, false, descending
...
/**
 * bitonic_compare_descending - helper to bitonic_merge, sorts contents of current
 * subarray in descending order
 * @x: subarray in current frame of recursion
 * @size: number of elements in `x`
 */
